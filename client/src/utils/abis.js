...
export const vjkSwapContractABI = [
  "function swapExactInputSingle(address , address , uint256 ) external returns (uint256 )",
  "function swapExactOutputSingle(address , address , uint256 , uint256 ) external returns (uint256 )",
];
